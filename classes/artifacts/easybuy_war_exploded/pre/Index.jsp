	...
	<div class="i_ban_bg">
        ...
        <div class="inews">
            ...
            <ul>
            	...
            	<li><span>[ 公告 ]</span>
                    <a href="${ctx}/admin/news?action=newsDeatil&id=${newsList.id}">${newsList.title}</a></li>
                </c:forEach>
            </ul>
            <div class="charge_t">
        ...
        <div class="hot_pro">
        	<div id="featureContainer">
                <div id="feature">
                    ...
                    <a class="h_prev" href="javascript:;">Previous</a>
                    <a class="h_next" href="javascript:;">Next</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="like">
        <div id="featureContainer1">
            <div id="feature1">
                ...
                <a class="l_prev" href="javascript:;">Previous</a>
                <a class="l_next" href="javascript:;">Next</a>
            </div>
        </div>
    </div>
    <!--End 猜你喜欢 End-->
